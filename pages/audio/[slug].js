...
const AudioDetails = ({ products, product}) => {
...
export const getStaticProps = async ({ params: { slug }}) => {
  const query = `*[_type == "audio" && slug.current == '${slug}'][0]`;
  const productsQuery = '*[_type == "audio"]'
